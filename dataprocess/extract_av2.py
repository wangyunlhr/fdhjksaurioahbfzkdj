...
#(Path(mask_dir) / f"{data_mode}-masks" / scene_id / f"{key}.feather")
# (data_dir / log_id / "city_SE3_egovehicle.feather")
# data_dir / log_id / "sensors" / "lidar" / f"{timestamp}.feather")
# data_dir / log_id / "annotations.feather"
# data_dir / log_id / "map"
