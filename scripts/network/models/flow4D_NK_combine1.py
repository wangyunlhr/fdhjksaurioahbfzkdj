...
from .basic.embedder_model_flow4D import DynamicEmbedder_4D_NK_combine
...
class Flow4D(nn.Module):
    def __init__(self, voxel_size = [0.2, 0.2, 0.2],
        ...
        self.embedder_4D_offset_add_noise = DynamicEmbedder_4D_NK_combine(voxel_size=voxel_size,
                                pseudo_image_dims=[grid_feature_size[0], grid_feature_size[1], grid_feature_size[2], num_frames], 
                                point_cloud_range=point_cloud_range,
                                feat_channels=point_output_ch, sample_step = sample_step)
