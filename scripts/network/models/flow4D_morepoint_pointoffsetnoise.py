...
from .basic.embedder_model_flow4D import DynamicEmbedder_4D_ori #DynamicEmbedder_4D_offset_add_noise, DynamicEmbedder_4D_restore, DynamicEmbedder_4D_pc0, DynamicEmbedder_4D
...
class Flow4D(nn.Module):
    def __init__(self, voxel_size = [0.2, 0.2, 0.2],
        ...
        # self.embedder_4D = DynamicEmbedder_4D_offset_add_noise(voxel_size=voxel_size,
    ...
    def forward(self, batch, training_flag):
        ...
        # if training_flag:
            # restore_point_dict, restore_loss= self.embedder_4D(pcs_dict, training_flag)
        # else:
        #     restore_point_dict = self.embedder_4D(pcs_dict, training_flag)
        self.timer[1].stop()
        ...
        # restore_all_dict = {'pc0s_restore': pc0s, 'pc1s_restore': pc1s}

        
        # dict_4d_restore = self.embedder_4D_restore(restore_all_dict)
