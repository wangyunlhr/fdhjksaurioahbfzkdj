...
from .basic.embedder_model_flow4D import DynamicEmbedder_4D_less_to_more
...
class Flow4D(nn.Module):
    ...
    def forward(self, batch, training_flag):
        ...
        if training_flag:
            loss_pc1, restore_pc0, restore_pc1 = self.diffusion_pc1.get_loss_multi(voxel_feats_list_batch_dict, voxel_coors_list_batch_dict, pc0s_voxel_feature, pc01_tesnor_4d, batch_sizes)
